...
-- -----------------------------------------------------
-- Table `rcv_db`.`stFormat`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `rcv_db`.`stFormat` ;

CREATE TABLE IF NOT EXISTS `rcv_db`.`stFormat` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `status` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `rcv_db`.`planillas` (
  ...
  `stFormat_id` INT NOT NULL,
  `agencias_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_planillas_stFormat1_idx` (`stFormat_id` ASC),
  INDEX `fk_planillas_agencias2_idx` (`agencias_id` ASC),
  CONSTRAINT `fk_planillas_stFormat1`
    FOREIGN KEY (`stFormat_id`)
    REFERENCES `rcv_db`.`stFormat` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `rcv_db`.`facturas` (
  ...
  `agencias_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_facturas_stFormat1_idx` (`stFormat_id` ASC),
  INDEX `fk_facturas_agencias1_idx` (`agencias_id` ASC),
  CONSTRAINT `fk_facturas_stFormat1`
    FOREIGN KEY (`stFormat_id`)
    REFERENCES `rcv_db`.`stFormat` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `rcv_db`.`contratos` (
  ...
  INDEX `fk_contratos_facturas1_idx` (`facturas_id` ASC),
  ...
  CONSTRAINT `fk_contratos_planillas1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_contratos_facturas1`
...
-- -----------------------------------------------------
-- Table `rcv_db`.`tipoFormato`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `rcv_db`.`tipoFormato` ;

CREATE TABLE IF NOT EXISTS `rcv_db`.`tipoFormato` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `tpFormatos` VARCHAR(60) NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `rcv_db`.`statusFormato`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `rcv_db`.`statusFormato` ;

CREATE TABLE IF NOT EXISTS `rcv_db`.`statusFormato` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `status` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `rcv_db`.`formatos`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `rcv_db`.`formatos` ;

CREATE TABLE IF NOT EXISTS `rcv_db`.`formatos` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `codigo` VARCHAR(45) NOT NULL,
  `agencias_id` INT NOT NULL,
  `tipoFormato_id` INT NOT NULL,
  `statusFormato_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_planillas_agencias1_idx` (`agencias_id` ASC),
  INDEX `fk_planillas_tipoFormato1_idx` (`tipoFormato_id` ASC),
  INDEX `fk_planillas_statusFormato1_idx` (`statusFormato_id` ASC),
  CONSTRAINT `fk_planillas_agencias1`
    FOREIGN KEY (`agencias_id`)
    REFERENCES `rcv_db`.`agencias` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_planillas_tipoFormato1`
    FOREIGN KEY (`tipoFormato_id`)
    REFERENCES `rcv_db`.`tipoFormato` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_planillas_statusFormato1`
    FOREIGN KEY (`statusFormato_id`)
    REFERENCES `rcv_db`.`statusFormato` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `rcv_db`.`codFact`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `rcv_db`.`codFact` ;

CREATE TABLE IF NOT EXISTS `rcv_db`.`codFact` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `codigo` VARCHAR(45) NOT NULL,
  `agencias_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_codFact_agencias1_idx` (`agencias_id` ASC),
  CONSTRAINT `fk_codFact_agencias1`
    FOREIGN KEY (`agencias_id`)
    REFERENCES `rcv_db`.`agencias` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
