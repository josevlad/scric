...
CREATE TABLE IF NOT EXISTS `rcv_db`.`cobertura` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `cobertura` DECIMAL(8,2) NOT NULL,
  `claseVehiculo_id` INT NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `rcv_db`.`concepto` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `gastosMedicos1` DECIMAL(6,2) NOT NULL,
  `invalidez` DECIMAL(6,2) NOT NULL,
  `muerte` DECIMAL(6,2) NOT NULL,
  `conceptocol` VARCHAR(45) NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `rcv_db`.`consepto`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `rcv_db`.`consepto` ;

CREATE TABLE IF NOT EXISTS `rcv_db`.`consepto` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `cobertura_id` INT NOT NULL,
  `gastosMedicos1` DECIMAL(8,2) NOT NULL,
  `invalidez1` DECIMAL(8,2) NOT NULL,
  `muerte1` DECIMAL(8,2) NOT NULL,
  `gastosMedicos2` DECIMAL(8,2) NOT NULL,
  `invalidez2` DECIMAL(8,2) NOT NULL,
  `muerte2` DECIMAL(8,2) NOT NULL,
  `dañosPropiedad` DECIMAL(8,2) NOT NULL,
  `grua` DECIMAL(8,2) NOT NULL,
  `estacionamiento` DECIMAL(8,2) NOT NULL,
  `indemnizacionSem` DECIMAL(8,2) NOT NULL,
  `asistenciaLegal` DECIMAL(8,2) NOT NULL,
  PRIMARY KEY (`id`),
