<?php
	class personsController extends Controller {
		...
		/**
		 * insert: 
		 * Metodo para guardar los datos que vienes via $_POST del formulario insert.phtml
		 * Este metodo funciona de la siguiente manera, primero verifica si existe
		 * POST del campo "save" y si no esta vacio, si es true, construye un arreglo con todos
		 * Los datos que viene por via POST: di (document identity), name y last_name
		 * 
		 * Luego se llama al método insertPerson perteneciente a la clase personsModel
		 * Este método recibe por parámetro el arreglo de los datos hechos anteriormente
		 * Y ejecuta el SQL para guardar los datos en la BD
		 * 
		 * Y por último, redireciona la vista del formulario a index del modulo
		 */
